    ...
    <div className="w-full bg-[#FFFBF2] text-[#111111] min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        <div className="space-y-6">
          ...
          <h1 className="text-6xl md:text-8xl font-black text-[#111111] tracking-tighter leading-none mb-8">
            Real Impact, <br className="hidden md:block" /> Real Locations.
          </h1>
          <p className="max-w-2xl mx-auto text-lg md:text-xl font-medium text-gray-400 leading-relaxed italic">
            "Transparency is at the heart of our mission. Explore the interactive map below to see exactly where your contributions are making a difference across Every corner of Tanzania."
          </p>
        </div>
      </section>
      ...
      <section className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pb-32">
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-16 items-start px-8">
            <div>
                <h2 className="text-3xl font-black text-[#111111] mb-6 leading-tight uppercase tracking-tighter">Beyond the Coordinates</h2>
                <p className="text-gray-500 leading-relaxed mb-8">
                    Each marker on this map represents more than just a GPS coordinate. It's a story of a community that now has clean water, a group of orphans who have a safe place to sleep, or a family that has regained their livelihood through sustainable poultry farming. 
                </p>
                <Link 
                    href="/gallery" 
            ...
            <div className="p-8 bg-white border-black/5 rounded-4xl">
                    <h3 className="text-xl font-black mb-4">How we choose locations?</h3>
                    <p className="text-sm text-gray-500 leading-relaxed">
                        We work closely with local community leaders and government officials to identify regions with the highest need and lowest accessibility to basic services.
                    </p>
                </div>
                <div className="p-8 bg-[#95E18A]/10 rounded-4xl border border-[#95E18A]/20">
                    <h3 className="text-xl font-black mb-4 text-[#2D5A27]">Help us expand our reach</h3>
                    <p className="text-sm text-[#2D5A27]/70 leading-relaxed mb-6">
                        There are still many areas in Tanzania that require immediate attention. Your feedback and support help us plan the next "Pulse" on our map.
                    </p>
                    <Link 
                        href="/donate" 
