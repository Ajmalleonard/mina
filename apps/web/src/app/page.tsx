                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {isLoading ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[1, 2, 3, 4, 5, 6].map((idx) => (
                                <div key={idx} className="bg-white border border-[#111111] flex flex-col h-full opacity-60">
                                    <div className="aspect-video relative overflow-hidden border-b border-[#111111] bg-gray-200">
                                    </div>
                        ...
                        <div className="text-center py-16">
                            <p className="text-lg text-gray-600 mb-4">Unable to load activities. Please ensure the API server is running.</p>
                            <button onClick={() => window.location.reload()} className="bg-[#111111] text-white px-8 py-3 text-sm font-medium hover:bg-gray-800">Retry</button>
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {activities.map((activity, idx) => (
                                <div key={activity.id} className={`${idx === activities.length - 1 ? 'bg-[#95E18A]' : 'bg-white'} border border-[#111111] flex flex-col group h-full`}>
                                    ...
                                    <div className="p-8 flex flex-col grow">
                                        <h3 className={`text-2xl font-bold mb-3 ${idx === activities.length - 1 ? 'text-[#111111]' : ''}`}>{activity.title}</h3>
                                        <p className={`text-sm mb-8 grow leading-relaxed ${idx === activities.length - 1 ? 'text-[#111111] font-medium' : 'text-gray-600'}`}>
                                        ...
                                        <div className="flex items-center justify-between mb-4 border border-[#111111] bg-white">
                                            ...
                                            <div className="flex items-center gap-1 font-bold">
                                                ...
                                                <input 
                                                    ...
                                                    onChange={(e) => setExactAmount(activity.id, parseInt(e.target.value) || 1)}
                                        ...
                                        <button 
                                            onClick={() => handleConfirm(activity.id, activity.title)}
