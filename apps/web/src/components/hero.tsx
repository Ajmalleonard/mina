          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-20">
              ...
              <div className="text-center max-w-4xl mx-auto mb-16">
                  ...
                  <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold text-[#111111] leading-[0.9] tracking-tight mb-8">
                      Your Empathy <br />
                      <span className="font-serif italic font-light">Transforms</span> Lives
            </h1>
                  <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
                      Empowering communities by transforming lives and fostering sustainable changes through compassionate giving across Tanzania.
            </p>

                  <div className="flex items-center justify-center gap-4">
                      <Link
                          href={primaryButtonLink}
                          className="bg-[#111111] text-white px-8 py-4 rounded-none font-medium text-lg flex items-center gap-2"
                      >
                          Join the Movement
              ...
              <div className="w-full bg-[#95E18A] rounded-none p-0 grid grid-cols-1 md:grid-cols-12 min-h-[250px] relative border border-[#111111]">

                  {/* Left: Big Stat */}
                  <div className="md:col-span-5 p-10 flex flex-col justify-center border-b md:border-b-0 md:border-r border-[#111111]">
                      ...
                      <Link href="/about" className="text-[#111111] text-sm font-bold underline decoration-2 underline-offset-4 hover:opacity-80">
                          Learn More
                      </Link>
            </div>

                  {/* Middle: Goal */}
                  <div className="md:col-span-3 p-10 flex flex-col justify-center border-b md:border-b-0 md:border-r border-[#111111] bg-[#8ce68c]">
                      <div className="flex items-center gap-2 mb-6">
                          <span className="text-xl">✻</span>
                          <span className="font-bold text-sm uppercase tracking-wider">Our Next Goal</span>
                      </div>
                  ...
                  <div className="md:col-span-4 p-8 flex items-center relative overflow-hidden bg-white/10">
                      <div className="flex gap-4 items-start relative z-10">
                          <div className="w-20 h-20 bg-gray-200 shrink-0 overflow-hidden relative grayscale border border-[#111111]">
                              <Image
                          ...
                          <div>
                              <p className="text-xs font-medium leading-relaxed mb-3">
                                  "Supporting this charity has been life-changing. I've seen firsthand the positive impact it has on communities in need. Truly inspiring!"
                              </p>
              ...
              <div className="mt-12 pt-8 border-t border-[#111111] flex justify-between items-center text-gray-500 text-sm grayscale opacity-80">
                  <span className="font-medium text-[#111111]">Our Partners & Supporters</span>
