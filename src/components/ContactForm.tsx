      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="bg-green-50 rounded-lg p-8 border border-green-200 relative z-10"
          >
            ...
            {isSubmitted ? (
              <motion.div
                ...
                className="bg-green-100 border border-green-300 text-green-700 p-4 rounded-md mb-6"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-green-200 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
              ...
              >
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 border border-green-200 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all resize-none"
              ...
              >
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full py-3 px-6 bg-green-600 hover:bg-green-700 text-white font-medium rounded-md shadow-sm transition-colors"
                >
                  Send Message
                </motion.button>
              </motion.div>
