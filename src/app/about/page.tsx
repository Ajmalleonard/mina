  ...
  return (
    <main className="min-h-screen">
      ...
      <HeroSection
        ...
        description="Our mission is to empower the Islamic community through education, support services, and sustainable programs."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-700 mb-6">
                ...
                a supportive ecosystem for  families. What started as a
                small community initiative has grown into a comprehensive
                foundation serving over 20,000+ of families across the region.
              </p>
              <p className="text-gray-700 mb-6">
                Our founders recognized the unique challenges faced by the
                 community and sought to build a platform that addresses
                these challenges while preserving cultural values and
                traditions.
              </p>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="bg-green-100 rounded-lg p-8 shadow-lg"
            >
              <h3 className="text-xl font-semibold text-green-800 mb-4">
                Foundation Timeline
              </h3>
              {[
                { year: "2021", event: "Mina Foundation established" },
                {
                  year: "2022",
                  event: "Distributed Ramadhan food packages accross Dar es Salaam",
                },
                { year: "2023", event: "Opened our community center" },
                {
                  year: "2024",
                  event: "Expanded services to include financial assistance",
                },
                {
                  year: "2025",
                  event: "Reached milestone of 10,000+ families supported",
                },
                ...
                >
                  <div className="flex-shrink-0 w-20 font-bold text-green-700">
                    {item.year}
                  </div>
                  <div className="flex-grow border-l-2 text-green-600 border-green-300 pl-4 pb-4">
                    {item.event}
                  </div>
                </motion.div>
              ))}
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            {[
              ...
              className="bg-white p-8 rounded-lg border border-green-200 text-center"
              >
      ...
      <section className="py-16 bg-gradient-to-r from-green-700 to-green-900 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          >
            Be part of our mission to strengthen Islamic families and build
